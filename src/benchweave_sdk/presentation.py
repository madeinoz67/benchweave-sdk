...
def create_ui_resources(destination: Path, package: str) -> None:
    ...
    (destination / "UI-GUIDE.md").write_text(
        ...
        "Keep UI resources under src/<package>/ui/. Add settings/ and presets/ only\n"
        "for configuration actions the descriptor actually implements. Keep the\n"
        "binding catalogue aligned with the descriptor and update exact byte hashes.\n\n"
