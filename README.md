...
Build an external device plugin without importing gateway internals. Python 3.13+, SDK 0.3.1, OTDP 0.2.2 and adapter API 1.1 are the baseline. This package is a separate wheel built alongside BenchWeave; published to PyPI as benchweave-sdk.
