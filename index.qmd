...
- [API reference](reference/index.qmd) — the structural-typing protocols (`Adapter`, `HostServices`, `OperationContext`, the provisional `CaptureServices`) and the testing, conformance, validation, presentation and packaging surfaces.
